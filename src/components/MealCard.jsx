...
function MealCard({
  ...
  const handleFavorite = () => {
    ...
    response.then((res) => addFavorite(res.data.meals[0]));
  };
  return (
    <div
      className="cookit-font card col-xl-3 col-lg-5 col-md-5 col-sm-11 z-index-1 meal-card shadow d-flex flex-row flex-wrap text-decoration-none">
